...
namespace Geb.Image
{
    ...
    public partial class ImageFloat
    {
        ...
        /// <param name="width"></param>
        /// <param name="height"></param>
        public unsafe ImageFloat(Int32 width, Int32 height, int lineSizeAlignmentBytes)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = true;
        ...
        public ImageFloat(Size size):this(size.Width,size.Height)
        {
        }
        ...
        public unsafe ImageFloat(Int32 width, Int32 height, void* data, bool isOwner = false)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = isOwner;
        ...
        public unsafe ImageFloat(String path)
        {
        ...
        public unsafe TImage Resize(int width, int height, InterpolationMode mode = InterpolationMode.NearestNeighbor)
        {
            ...
            TImage imgDst = new ImageFloat(width, height);
