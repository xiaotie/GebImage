...
namespace Geb.Image
{
    ...
    public partial class ImageHsl
    {
        ...
        /// <param name="width"></param>
        /// <param name="height"></param>
        public unsafe ImageHsl(Int32 width, Int32 height, int lineSizeAlignmentBytes)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = true;
        ...
        public ImageHsl(Size size):this(size.Width,size.Height)
        {
        }
        ...
        public unsafe ImageHsl(Int32 width, Int32 height, void* data, bool isOwner = false)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = isOwner;
