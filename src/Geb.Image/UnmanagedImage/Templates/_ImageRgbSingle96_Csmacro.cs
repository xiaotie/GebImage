...
namespace Geb.Image
{
    ...
    public partial class ImageRgbSingle96
    {
        ...
        public unsafe ImageRgbSingle96(Int32 width, Int32 height)
        {
        ...
        public unsafe ImageRgbSingle96(Int32 width, Int32 height, void* data)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            Width = width;
        ...
        public unsafe ImageRgbSingle96(String path)
        {
        ...
        public ImageRgbSingle96(Bitmap map)
        {
        ...
        public unsafe TImage ApplyModeFilter(int size)
        {
            ...
            ImageRgbSingle96 mask = this.Clone();
            int height = this.Height;
            int width = this.Width;
        ...
        public unsafe TImage Resize(int width, int height, InterpolationMode mode = InterpolationMode.NearestNeighbor)
        {
            ...
            TImage imgDst = new ImageRgbSingle96(width, height);
