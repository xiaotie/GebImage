...
namespace Geb.Image
{
    ...
    public partial class ImageGrad
    {
        ...
        /// <param name="width"></param>
        /// <param name="height"></param>
        public unsafe ImageGrad(Int32 width, Int32 height, int lineSizeAlignmentBytes)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = true;
        ...
        public ImageGrad(Size size):this(size.Width,size.Height)
        {
        }
        ...
        public unsafe ImageGrad(Int32 width, Int32 height, void* data, bool isOwner = false)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = isOwner;
        ...
        public unsafe ImageGrad(String path)
        {
        ...
        public unsafe TImage Resize(int width, int height, InterpolationMode mode = InterpolationMode.NearestNeighbor)
        {
            ...
            // 计算 channel 数量
            int nChannel = sizeof(TPixel) / sizeof(TChannel);
            TImage imgDst = new ImageGrad(width, height);
