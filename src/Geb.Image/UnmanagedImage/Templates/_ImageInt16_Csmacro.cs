...
namespace Geb.Image
{
    ...
    public partial class ImageInt16
    {
        ...
        public unsafe ImageInt16(Int32 width, Int32 height)
        {
        ...
        /// <param name="width"></param>
        /// <param name="height"></param>
        public unsafe ImageInt16(Int32 width, Int32 height, int lineSizeAlignmentBytes)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = true;
        ...
        public ImageInt16(Size size):this(size.Width,size.Height)
        {
        }
        ...
        public unsafe ImageInt16(Int32 width, Int32 height, void* data, bool isOwner = false)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = isOwner;
        ...
        public unsafe ImageInt16(String path)
        {
        ...
        public unsafe TImage Resize(int width, int height, InterpolationMode mode = InterpolationMode.NearestNeighbor)
        {
            ...
            TImage imgDst = new ImageInt16(width, height);
