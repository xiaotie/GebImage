...
using TImage = Geb.Image.Hidden.Image_Template;
...
namespace Geb.Image.Hidden
{
    public class Image_Template
    {
        ...
        private Geb.Image.PixelFormat GetOutputBitmapPixelFormat()
        {
            return Geb.Image.PixelFormat.Format8bpp;
        }
        ...
        public unsafe Image_Template(Int32 width, Int32 height)
        {
        ...
        /// <param name="width"></param>
        /// <param name="height"></param>
        public unsafe Image_Template(Int32 width, Int32 height, int lineSizeAlignmentBytes)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = true;
        ...
        public Image_Template(Size size):this(size.Width,size.Height)
        {
        }
        ...
        public unsafe Image_Template(Int32 width, Int32 height, void* data, bool isOwner = false)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = isOwner;
        ...
        public unsafe TImage ApplyModeFilter(int size)
        {
            ...
            Image_Template mask = this.Clone();
            int height = this.Height;
            int width = this.Width;
        ...
        public unsafe TImage Resize(int width, int height, InterpolationMode mode = InterpolationMode.NearestNeighbor)
        {
            ...
            TImage imgDst = new Image_Template(width, height);
