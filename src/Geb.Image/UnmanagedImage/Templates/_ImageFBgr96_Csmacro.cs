...
namespace Geb.Image
{
    ...
    public partial class ImageFBgr96
    {
        ...
        public unsafe ImageFBgr96(Int32 width, Int32 height)
        {
        ...
        /// <param name="width"></param>
        /// <param name="height"></param>
        public unsafe ImageFBgr96(Int32 width, Int32 height, int lineSizeAlignmentBytes)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = true;
        ...
        public ImageFBgr96(Size size):this(size.Width,size.Height)
        {
        }
        ...
        public unsafe ImageFBgr96(Int32 width, Int32 height, void* data, bool isOwner = false)
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width");
            else if (height <= 0) throw new ArgumentOutOfRangeException("height");
            _isOwner = isOwner;
        ...
        public unsafe ImageFBgr96(String path)
        {
        ...
        public unsafe TImage Resize(int width, int height, InterpolationMode mode = InterpolationMode.NearestNeighbor)
        {
            ...
            TImage imgDst = new ImageFBgr96(width, height);
